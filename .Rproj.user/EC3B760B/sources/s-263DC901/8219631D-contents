...
genMCMC = function( datFrm=myDataFrame , yName="y" , x1Name="x1" , x2Name="x2" ,
                    numSavedSteps=50000 ,  thinSteps=1 , saveName=saveName ,
...
smryMCMC = function(  codaSamples , 
                      ...
                      x1contrasts=x1contrasts , x2contrasts=x2contrasts , x1x2contrasts=x1x2contrasts ,                     saveName=saveName ) {
...
plotMCMC = function( codaSamples , 
  ...
  compInfo = plotPost( log10(mcmcMat[,"nu"]) , xlab=expression("log10("*nu*")") ,
                       main="Normality", compVal=compVal , ROPE=ROPE )
  compInfo = plotPost( mcmcMat[,"sigmaMode"] , xlab="param. value" ,
                       main="Mode of Cell Sigma's", compVal=compVal , ROPE=ROPE )
  compInfo = plotPost( mcmcMat[,"sigmaSD"] , xlab="param. value" ,
                       main="SD of Cell Sigma's", compVal=compVal , ROPE=ROPE )
  if ( !is.null(saveName) ) {
